...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { cantidad: @producto.cantidad, categoria: @producto.categoria, nombre: @producto.nombre, unidad: @producto.unidad } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { cantidad: @producto.cantidad, categoria: @producto.categoria, nombre: @producto.nombre, unidad: @producto.unidad } }
